...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if(isset($_POST['nama']))
    $nama = ($_POST["nama"]);
    if(isset($_POST['no_sim']))
    $no_sim = ($_POST["no_sim"]);
    if(isset($_POST['alamat']))
    $alamat = ($_POST["alamat"]);

    $query2 = "INSERT INTO driver (id_driver, nama, no_sim, alamat) VALUES('', '$nama', $no_sim, '$alamat')";
...
<body>
                ...
                <ul class="navbar-nav me-auto ms-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <li><a class="dropdown-item" href="insert_data_bus.php">Bus</a></li>
                            <li><a class="dropdown-item nav-link active" href="insert_data_driver.php">Driver</a></li>
    ...
    <main class="container border border-primary" style="width: 400px; margin-top: 20px;">
        <h1 style="text-align: center; margin-bottom: 20px;">Insert Data Driver</h1>
        <div>
            <form action="insert_data_driver.php" method="POST">
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="no_sim" id="no_sim" placeholder="no_sim">
                </div>
                <div class="mb-3">
