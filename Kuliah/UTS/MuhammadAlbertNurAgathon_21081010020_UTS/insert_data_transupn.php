...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if(isset($_POST['jumlah_km']))
    $jumlah_km = ($_POST["jumlah_km"]);
    if(isset($_POST['tanggal']))
    $tanggal = ($_POST["tanggal"]);

    $query2 = "INSERT INTO trans_upn (id_trans_upn , id_kondektur, id_bus, id_driver, jumlah_km, tanggal) VALUES(' ',$id_kondektur, $id_bus, $id_driver, $jumlah_km, $tanggal)";
...
<body>
                ...
                <ul class="navbar-nav me-auto ms-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <li><a class="dropdown-item" href="insert_data_bus.php">Bus</a></li>
                            ...
                            <li><a class="dropdown-item nav-link active" href="insert_data_transupn.php">Transupn</a></li>
                        </ul>
                    </li>
                </ul>
            </div>
    ...
    <main class="container border border-primary" style="width: 400px; margin-top: 20px;">
        <h1 style="text-align: center; margin-bottom: 20px;">Insert Data Transupn</h1>
        <div>
            <form action="insert_data_transupn.php" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select" name="id_kondektur" id="id_kondektur">
                        ...
                        <?php while ($data = mysqli_fetch_array($result_kondektur)) : ?>
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select" name="id_bus" id="id_bus">
                        ...
                        <?php while ($data = mysqli_fetch_array($result_bus)) : ?>
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select" name="id_driver" id="id_driver">
                        <option selected>Open this id driverr</option>
                        <?php while ($data = mysqli_fetch_array($result_driver)) : ?>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="jumlah_km" id="jumlah_km" placeholder="jumlah_km">
                </div>
                <div class="mb-3">
