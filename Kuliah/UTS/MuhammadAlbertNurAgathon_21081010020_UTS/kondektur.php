...
<body>
                ...
                <ul class="navbar-nav me-auto ms-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a class="dropdown-item nav-link active" href="kondektur.php">Kondektur</a></li>
    ...
    <main class="container" style="width: 800px;">
        <h1 style="text-align: center; margin-bottom: 20px;">Data Kondektur</h1>
                ...
                <?php while ($data = mysqli_fetch_array($result)) : ?>
                    <tr class="text-center">
                        <td class="d-flex justify-content-center">
                            <a class="btn btn-warning btn-sm" href="update_data_kondektur.php?id_kondektur=<?php echo $data["id_kondektur"]; ?> " style="margin-right: 5px;">Update</a>
                            <a class="btn btn-danger btn-sm" href="<?php echo "delete_kondektur.php?id_kondektur=" . $data['id_kondektur']; ?>">Delete</a>
                        </td>
