...
<body>
                ...
                <ul class="navbar-nav me-auto ms-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a class="dropdown-item nav-link active" href="transupn.php">Trans_UPN</a></li>
                        </ul>
                    </li>
                    <li class="nav-item dropdown">
    ...
    <main class="container" style="width: 800px;">
        <h1 style="text-align: center; margin-bottom: 20px;">Data Transupn</h1>
        <table class="table table-success table-striped table-bordered">
            <thead>
                <tr class="text-center">
                    <th scope="col">Action</th>
                    <th scope="col">ID Transupn</th>
                ...
                <?php while ($data = mysqli_fetch_array($result)) : ?>
                    <tr class="text-center">
                        <td class="d-flex justify-content-center">
                            <a class="btn btn-warning btn-sm" href="update_data_transupn.php?id_trans_upn=<?php echo $data["id_trans_upn"]; ?> " style="margin-right: 5px;">Update</a>
                            <a class="btn btn-danger btn-sm" href="<?php echo "delete_transupn.php?id_trans_upn=" . $data['id_trans_upn']; ?>" >Delete</a>
                        </td>
