...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $query2 = "INSERT INTO customers (customerNumber, customerName, contactLastName, contactFirstName, phone, addressLine1, addressLine2, city, state, postalCode, country, salesRepEmployeeNumber, creditLimit) VALUES($customerNumber, '$customerName', '$contactLastName', '$contactFirstName', '$phone', '$addresLine1', '$addresLine2', '$city', '$state', '$postalCode', '$country', $salesRepEmployeeNumber, $creditLimit)";
...
<body>
    ...
    <main class="container">
        ...
        <div>
            <form action="insert_data_customers.php" method="POST">
                <div class="mb-3">
