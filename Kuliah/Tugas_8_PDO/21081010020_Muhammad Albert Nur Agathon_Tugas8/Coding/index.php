                ...
                <?php while ($data = $result->fetch(PDO::FETCH_ASSOC)) : ?>
                    <tr class="dataProduct">
                        <td class="d-flex justify-content-center">
                            <a class="btn btn-warning btn-sm" href="update_data_product.php?productCode=<?php echo $data["productCode"]; ?>" style="margin-right: 5px;">Update</a>
                            <a class="btn btn-danger btn-sm" href="delete_data_product.php?productCode=<?php echo $data["productCode"]; ?>">Delete</a>
                        </td>
                        <td><?php echo $i; ?></td>
