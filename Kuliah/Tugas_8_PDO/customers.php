                ...
                <?php while ($data = $result->fetch(PDO::FETCH_ASSOC)) : ?>
                    <tr>
                        <td class="d-flex justify-content-center">
                            <a class="btn btn-warning btn-sm" href="update_data_customers.php?customerNumber=<?php echo $data["customerNumber"]; ?>" style="margin-right: 5px;">Update</a>
                            <a class="btn btn-danger btn-sm" href="delete_data_customers.php?customerNumber=<?php echo $data["customerNumber"]; ?>">Delete</a>
                        </td>
                        <td><?php echo $i; ?></td>
